...
#define SensorApp_MAX_CLUSTERS       1
#define SensorApp_CLUSTERID          1

// Send Message Timeout
#define SensorApp_SEND_MSG_TIMEOUT   5000     // Every 5 seconds

// Application Events (OSAL) - These are bit weighted definitions.
#define SensorApp_SEND_MSG_EVT       0x0001
#define SensorApp_UART_RX_CB_EVT     0x0002 //自定义串口事件
/*********************************************************************
 * MACROS
 */
